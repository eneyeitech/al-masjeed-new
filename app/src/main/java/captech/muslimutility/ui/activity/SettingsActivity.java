            ...
            switch (key) {
                ...
                case "mazhab":
                    ...
                    if (String.valueOf(value).equals("2")) {
                        ...
                        TimingsFragment.c5.setVisibility(View.GONE);
                        TimingsFragment.c6.setVisibility(View.GONE);
                    } else {
                        PrayingFragment.c5.setVisibility(View.VISIBLE);
                        PrayingFragment.c6.setVisibility(View.VISIBLE);
                        TimingsFragment.c5.setVisibility(View.VISIBLE);
                        TimingsFragment.c6.setVisibility(View.VISIBLE);
                    }
                    break;
